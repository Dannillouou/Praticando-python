...
# receber a quantidade que deve ser pintada 
...
#receber o modo como a tinta deve ser comprada
def recebe_modo() -> str:
    ...
    while valor_invalido:
        try:
            ...
            print(
                "\"latas e galoes\": para misturar latas e galões ao mesmo tempo, com o menor desperdício.")
            # recebimento
...
# Calcular o orçamento de acordo com quantidade de tinta e a forma como
# a tinta vai ser comprada
